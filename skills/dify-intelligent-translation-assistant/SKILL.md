---
name: dify-intelligent-translation-assistant
description: Translate text between multiple languages via Dify API. Use when the user needs to convert text from one language to another by asking in natural language (e.g., "Translate 'hello' to French" or "What is 'thank you' in Spanish?").

---

# dify-intelligent-translation-assistant

Use Dify chat api to translate text.
...
curl -X POST "$DIFY_API_HOST/v1/chat-messages" \
