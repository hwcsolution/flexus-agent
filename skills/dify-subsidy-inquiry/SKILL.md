---
name: dify-subsidy-inquiry
description: Search for relevant subsidies through the Dify API. When users want to search for corresponding subsidy policies based on keywords of the company name.


---

# dify-subsidy-inquiry

Use Dify chat stream to search for corresponding subsidy policies based on the keywords of the enterprise name entered by the user.
