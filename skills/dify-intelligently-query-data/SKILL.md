---
name: dify-intelligently-query-data
description: Answer data-related questions via Dify API. Use when the user wants to query, analyze, or visualize data by asking questions in natural language.

---

# dify-intelligently-query-data

Use Dify chat api to query data.
