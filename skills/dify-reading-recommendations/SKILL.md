---
name: dify-reading-recommendations
description: Recommend books through the Dify API. It is necessary to recommend reading materials suitable for a student's current stage of development based on relevant information.


---

# dify-reading-recommendations

Using Dify workflow to recommend reading materials.
