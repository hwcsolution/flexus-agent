---
name: dify-question-attri
description: Attributing through the Dify API, conducting a systematic analysis of incorrect questions based on the learning characteristics of different grades, and then summarising the root causes of errors.

---

# dify-question-attri

Use Dify chat api to attribution of mistakes.
...
DIFY_API_KEY=$(cat ~/.config/d ify/api_key/{skill_name})
