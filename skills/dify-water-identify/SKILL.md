---
name: dify-water-identify
description: Intelligently identify water meter information through the Dify API. Input a water meter image and the recognition will return the meter reading and status.
---

# dify-water-identify

Use Dify chat api to recognise the image.
...
```bash
curl -X POST "$DIFY_API_HOST/v1/parameters"\
