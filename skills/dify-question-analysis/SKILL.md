---
name: dify-question-analysis
description: Generate analysis through the dify API, breaking down answering steps based on the input grade, questions, article materials, and problems, sorting out question patterns, and consolidating the foundation for reading comprehension.

---

# dify-question-analysis

Analysing problem-solving methods through difyapi.
