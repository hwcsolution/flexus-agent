---
name: dify-image-analysis
description: Image analysis Dify API, this intelligent agent example is only to detect whether employees use their phones during working hours.
---

# dify-image-analysis

Use Dify chat api to analysis image.
