---
name: dify-meeting-minutes-summary
description: Analyze and summarize the core content of your uploaded meeting record files (including meeting process, discussion points, and resolutions), generate a concise and structured meeting summary to help you quickly grasp the key information of the meeting.
---

# dify-meeting-minutes-summary

Use Dify chat api to analyze and summarize your uploaded meeting record files.
...
curl -X GET "$DIFY_API_HOST/v1/workflows/run" \
