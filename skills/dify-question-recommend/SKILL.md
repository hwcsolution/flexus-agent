---
name: dify-question-recommend
description: Using the dify API to distinguish by grade level and define question types, preferentially recommending real exam questions and similar benchmark exercises to meet the needs of layered training

---

# dify-question-recommend

Use Dify chat api to recommended real exam questions.
